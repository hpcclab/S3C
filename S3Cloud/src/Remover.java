...
public class Remover {
	...
	public void waitToRemove() {
		...
		try{
			...
			File textFile = new File(Config.storeLocation + File.separator + fileToRemove);
			if (textFile.exists())
				textFile.delete();
			
			File keyFile = new File(Config.storeLocation + File.separator + fileToRemove.replace(".txt", ".key"));
			if(keyFile.exists())
				keyFile.delete();
