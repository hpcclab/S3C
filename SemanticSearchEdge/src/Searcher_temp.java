...
public class Searcher_temp {
	...
	public void displayResults() {
         ...
         * Compute Semantics
         * 
         * Uses the comparison package from WordSemantics.
         * This one is specifically for thesaurus terms
         */
        protected double computeSemantics(String word, float termWeight, int size){
            
            WordSemantics comparer = new WordSemantics();
            double score = comparer.compare(query, word);
            
            if (score == -1){
                return termWeight / size;
            } else {
                return score;
            }
        }
         ...
         * 
         * Uses the comparison package from WordSemantics.
         * This one is specifically for wikipedia terms because the original
         * query was not being saved properly with the above function.
         */
        protected double computeSemantics(String original, String word, float termWeight, int size){
            
            WordSemantics comparer = new WordSemantics();
            double score = comparer.compare(original, word);
