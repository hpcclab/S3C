...
public class Searcher {
	...
	public Searcher() {
		this.query = "";
		this.weights = new HashMap<>();             // List of terms and their weights based on semantic closeness
		this.queryVector = new ArrayList<>();       // List of terms to send to the server
		...
		this.synonymsKey = new HashMap<>();         // Only the synonyms of the search query. This is only used for printing
	}
	...
	private void shuffleQuery(String[] query_phrase) {
		 ...
		 */
		for(String item : sub){
			ArrayList<String> i = new ArrayList<>(Arrays.asList(item.split(" ")));
			Permutation("", i, res);
		}
